...
namespace AtomicMarketApiClient.Test.Stats
{
    ...
    public class StatsApiTest
    {
        ...
        {
            AtomicMarketApiFactory.Version1.StatsApi.Collections(new StatsUriParameterBuilder().WithCollectionName(TEST_COLLECTION).WithSymbol("WAX")).GetAwaiter().GetResult().Should().BeOfType<CollectionsDto>();
            ...
            AtomicMarketApiFactory.Version1.StatsApi.Collections(new StatsUriParameterBuilder().WithCollectionName(TEST_COLLECTION).WithSymbol("WAX").WithOrder(SortStrategy.Ascending)).GetAwaiter().GetResult().Should().BeOfType<CollectionsDto>();
        ...
        {
            AtomicMarketApiFactory.Version1.StatsApi.Collection(TEST_COLLECTION, new StatsUriParameterBuilder().WithCollectionName(TEST_COLLECTION).WithSymbol("WAX")).GetAwaiter().GetResult().Should().BeOfType<CollectionDto>();
        ...
        public void Accounts()
        {
            ...
            AtomicMarketApiFactory.Version1.StatsApi.Accounts(new StatsUriParameterBuilder().WithAfter(after).WithSymbol("WAX").WithLimit(1)).GetAwaiter().GetResult().Should().BeOfType<AccountsDto>();
            ...
            AtomicMarketApiFactory.Version1.StatsApi.Accounts(new StatsUriParameterBuilder().WithCollectionName(TEST_COLLECTION).WithSymbol("WAX").WithLimit(1).WithOrder(SortStrategy.Ascending)).GetAwaiter().GetResult().Should().BeOfType<AccountsDto>();
        ...
        public void Account()
        {
            AtomicMarketApiFactory.Version1.StatsApi.Account(TEST_ACCOUNT, new StatsUriParameterBuilder().WithSymbol("WAX")).GetAwaiter().GetResult().Should().BeOfType<AccountDto>();
